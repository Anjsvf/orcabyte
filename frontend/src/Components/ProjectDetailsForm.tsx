      ...
      fields: (
        <div className="space-y-6">
          <div>
            ...
            <input
              type="text"
              className={`mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-purple-600 focus:ring-purple-600 p-2 ${
          ...
          {!projectDetails.hasServer && (
            <>
              <div>
                ...
                <select
                  className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-purple-500 focus:ring-blue-600 p-2"
